...
export class UserService {
  ...
  setCompanyEndorsement(data: any) {
    this.setData(this.companyEndorsement, data);
  }
  getCompanyEndorsement() {
    return this.extractData(this.companyEndorsement);
  }

  setStudentExitPoll(data: any) {
    this.setData(this.exitPollDetails, data);
  }
  getStudentExitPoll() {
